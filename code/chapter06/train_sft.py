...
def main() -> None:
    ...
    trainer.train()
    # Full SFT of a 4B model needs ~32 GiB in total (weights + grads + AdamW states);
    # with device_map="auto" that is split across GPUs, so read the printed total.
    report_peak_gpu_memory("full SFT training")
