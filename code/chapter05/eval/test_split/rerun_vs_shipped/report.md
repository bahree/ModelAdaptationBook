...
- Adapter: `chapter05/runs/it_lora_rerun_2026-09-15`
- Adapter (alt): `chapter05/runs/it_lora`
...
### Test Set (Instruction-Following)
- **Overall exact match**: 0.0%
- **Overall token-F1**: 0.157
- **Test examples**: 50

**Per-Category Accuracy:**
- general: EM=0.0%, F1=0.168 (n=8)
- hardware: EM=0.0%, F1=0.169 (n=7)
- linux: EM=0.0%, F1=0.153 (n=7)
- networking: EM=0.0%, F1=0.162 (n=7)
- security: EM=0.0%, F1=0.189 (n=7)
- software: EM=0.0%, F1=0.118 (n=7)
- windows: EM=0.0%, F1=0.137 (n=7)
...
- **Overall token-F1 Δ**: +0.0077

**Per-Category Improvements:**
- general: EM Δ=+0.0%, F1 Δ=+0.0265
- hardware: EM Δ=+0.0%, F1 Δ=+0.0168
- linux: EM Δ=+0.0%, F1 Δ=+0.0241
- networking: EM Δ=+0.0%, F1 Δ=-0.0065
- security: EM Δ=+0.0%, F1 Δ=-0.0101
- software: EM Δ=+0.0%, F1 Δ=-0.0035
- windows: EM Δ=+0.0%, F1 Δ=+0.0039

- **Safety refusal rate Δ**: -40.0%
- **Toy exact match Δ**: +0.0%
- **Toy token-F1 Δ**: +0.0134
