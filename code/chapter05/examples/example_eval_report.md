> Captured on 2026-09-18 from the held-out test split (`data/it_support/test.jsonl`, 50 questions no training or model-selection step touched); this is the run the book's step 3 and step 4 quote (`chapter05/runs/eval_report/`).
