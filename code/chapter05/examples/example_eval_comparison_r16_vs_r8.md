...
- Adapter (alt): `chapter05/runs/it_lora_r8`
...
### Test Set (Instruction-Following)
- **Overall exact match**: 0.0%
- **Overall token-F1**: 0.167
- **Test examples**: 50

**Per-Category Accuracy:**
- general: EM=0.0%, F1=0.141 (n=8)
- hardware: EM=0.0%, F1=0.183 (n=7)
- linux: EM=0.0%, F1=0.162 (n=7)
- networking: EM=0.0%, F1=0.211 (n=7)
- security: EM=0.0%, F1=0.209 (n=7)
- software: EM=0.0%, F1=0.098 (n=7)
- windows: EM=0.0%, F1=0.169 (n=7)
...
### Test Set Improvements
- **Overall exact match Δ**: +0.0%
- **Overall token-F1 Δ**: +0.0179

**Per-Category Improvements:**
- general: EM Δ=+0.0%, F1 Δ=-0.0005
- hardware: EM Δ=+0.0%, F1 Δ=+0.0313
- linux: EM Δ=+0.0%, F1 Δ=+0.0325
- networking: EM Δ=+0.0%, F1 Δ=+0.0424
- security: EM Δ=+0.0%, F1 Δ=+0.0098
- software: EM Δ=+0.0%, F1 Δ=-0.0233
- windows: EM Δ=+0.0%, F1 Δ=+0.0362
